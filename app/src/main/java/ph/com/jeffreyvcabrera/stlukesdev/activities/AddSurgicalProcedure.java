...
public class AddSurgicalProcedure extends AppCompatActivity implements AsyncTaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_surgical_procedure);

        listview = (ListView) findViewById(R.id.listEdit);
        save = (Button) findViewById(R.id.save_procedure);
        content = (EditText) findViewById(R.id.content_procedure_et);

        new ListActionsAPI(this, "/api_patients/listaction/"+getIntent().getExtras().getInt("id")+"/"+4).execute();
        ...
        if (result == "error") {
            ...
            try {
                ...
                if (success) {
                    ...
                    Toast.makeText(this, "Surgical Procedure added", Toast.LENGTH_LONG).show();
