...
public class AddAction extends AppCompatActivity implements AsyncTaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        content = (EditText) findViewById(R.id.content_action_et);


        new ListActionsAPI(AddAction.this, "/api_patients/listaction/"+getIntent().getExtras().getInt("id")+"/"+1).execute();
        ...
        if (result == "error") {
            ...
            try {
                ...
                if (success) {
                    ...
                    Toast.makeText(this, "Action Added", Toast.LENGTH_LONG).show();
