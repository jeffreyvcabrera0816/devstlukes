...
public class PatientsListSortByRoomFragment extends android.support.v4.app.Fragment implements AsyncTaskListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        new API(getActivity(), this).execute("POST", "/api_patients/list/room/"+role+"/"+id);
